...
<tr>
    <td><?= $i;?></td>
    <td class="text-capitalize"><a href="pagos.php?<?php if( $row['Alu_NroDocumento']=='' ){echo 'patron='.$row['Alu_Codigo']; }else{ echo "cursor=".$row['Alu_NroDocumento']; } ?>"><?= $row['Alu_Apellido']. " ". $row['Alu_Nombre'];?></a></td>
